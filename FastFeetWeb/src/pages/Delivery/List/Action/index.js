...
export default function Action({
  ...
  // const setDeliveries = useState(null);
  ...
  async function handleDelete() {
    try {
      ...
      // // eslint-disable-next-line react/prop-types
      const deliveryFilter = deliveries.filter(d => d.id !== id);
      setDeliveries(deliveryFilter);
...
Action.propTypes = {
  ...
  deliveries: PropTypes.oneOfType([PropTypes.array, PropTypes.object])
    .isRequired,
